...
bot.user.setPresence({
    game: {
        name: `SonicNetwork -> (Release)`,
        type: "STREAMING",
        url: "https://twitch.tv/SonicNetwork"
      }
    }
  );
});
...
if (command === 'help') {
  ...
  const response = new Discord.RichEmbed()
    .setColor("#8b1e9b")
    .setAuthor(`Welcome to the new version of SonicNetwork.`,"","https://discord.gg/DAhP6SGdAs")
    .setTitle(":flag_id: - SonicNetwork - Help Menu - :flag_id:")
...
if (command === 'buy') {
  ...
  const privbuyembed = new Discord.RichEmbed()
    ...
    .setColor('#ff0000')
    .setTitle(':flag_id: - Sonic Network - Buy Menu - :flag_id:')
    ...
    .addField("```PLANS```", "```diff\n-Simples\n-Normal\n-Advanced\n-Angel\n-Demon```", true)
    .addField("```SPECIFICATIONS```", "```yaml\n120 Sec\n300 Sec\n600 Sec\n1200 Sec\n3600 Sec\n```", true)
    .addField("```PRICE```", "```http\n4,97 USD\n9,93 USD\n14,90 USD\n19,86 USD\n29,79 USD\n```", true)
    .addField("```METHODS```", "**__BITCOIN__ ONLY!**")
...
const methodsem = new Discord.RichEmbed()
  .setColor("#ff0000")
  .setTitle(":flag_id: - Sonic Network - Methods DDoS - :flag_id:")
  ...
  .addField("**Layer 4 TCP**", "```http\nTELNET\nTCP_VOX\nTCP_XMAS```", true)        
  .setTimestamp()
  .setFooter("Sonic - Network.", "https://media.discordapp.net/attachments/683751224721670151/685405339364884503/images.jpg?width=398&height=398");
...
const metodoembed = new Discord.RichEmbed()
  .setColor("#ff0000")
  .setTitle("Database Editor -> SonicNetwork")
...
if (args < 1) {
  const response = new Discord.RichEmbed()
    ...
    .setTimestamp()
    .setFooter(`${msg.author.username} - Sonic Network.`, `${msg.author.displayAvatarURL}`);
...
//  
  const lookembed = new Discord.RichEmbed()
    .setColor("#ff0000")
    .setTitle(":flag_id: ERROR LOG :flag_id:")
    .setThumbnail(`${msg.author.displayAvatarURL}`)
...
//
   response = new Discord.RichEmbed()
    .setColor("#249c2b")
    .setTitle(":flag_id: - Sonic Network - Host Lookup Tool - :flag_id:")
    .setDescription("Requested Host Data.")
